...
import {createProduct} from "@/prisma/actions";
            ...
            <div className='border p-8 rounded-md'>
                <FormContainer action={createProduct}>
                    <div className="grid gap-4 md:grid-cols-2 my-4">
                        ...
                        <FormInput name="company" type="text" label="product company" defaultValue={company} />
                        <PriceInput />
                        <ImageInput />
                    </div>
                    ...
                    <SubmitButton text="created product" className="mt-8" />
                </FormContainer>
            </div>
        </section>
    );
